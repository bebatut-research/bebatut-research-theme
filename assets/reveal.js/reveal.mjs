...
var qe = (c, e, i) => (e in c ? pi(c, e, { enumerable: !0, configurable: !0, writable: !0, value: i }) : (c[e] = i)),
  Q = (c, e) => {
    for (var i in e || (e = {})) yi.call(e, i) && qe(c, i, e[i]);
    if (xt) for (var i of xt(e)) bi.call(e, i) && qe(c, i, e[i]);
    return c;
  },
  We = (c, e) => vi(c, mi(e));
...
const ge = (c, e) => {
    for (let i in e) c[i] = e[i];
    return c;
  },
  E = (c, e) => Array.from(c.querySelectorAll(e)),
  Ke = (c, e, i) => {
  ...
  V = (c, e) => {
    if (c && typeof c.closest == "function") return c.closest(e);
    for (; c; ) {
      if (xe(c, e)) return c;
      c = c.parentElement;
    }
  ...
  Ei = (c, e = 0) => {
    ...
    if (c) {
      ...
      return (
        (c.style.height = "0px"),
        c.parentElement && (c.parentElement.style.height = "auto"),
        (t = e - (((i = c.parentElement) == null ? void 0 : i.offsetHeight) || 0)),
        (c.style.height = s + "px"),
        c.parentElement && c.parentElement.style.removeProperty("height"),
        t
      );
    }
    return e;
  ...
  le = /(iphone|ipod|ipad|android)/gi.test(Vt) || (navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1),
  Ft = /android/gi.test(Vt);
var ki = (function (c) {
  if (c) {
    var e = function (f) {
        return [].slice.call(f);
      ...
      q = {
        ...
        maxSize: 512,
        multiLine: !0,
        observeMutations: "MutationObserver" in c && { subtree: !0, childList: !0, characterData: !0 },
      },
      W = null,
      L = function () {
  ...
  function F(f, S) {
    var T = Object.assign({}, q, S),
      X = f.map(function (K) {
        var ie = Object.assign({}, T, { element: K, active: !0 });
        return (
          (function (D) {
            ((D.originalStyle = { whiteSpace: D.element.style.whiteSpace, display: D.element.style.display, fontSize: D.element.style.fontSize }),
              B(D),
              (D.newbie = !0),
              (D.dirty = !0),
              r.push(D));
          })(ie),
          { element: K, fit: U(ie, a), unfreeze: z(ie), freeze: R(ie), unsubscribe: re(ie) }
        );
      });
    return (h(), X);
  }
  ...
  load(e, i = {}) {
    ...
    (E(e, "img[data-src], video[data-src], audio[data-src], iframe[data-src]").forEach((a) => {
      ...
      E(e, "video, audio").forEach((a) => {
        ...
        (E(a, "source[data-src]").forEach((o) => {
          ...
          le && a.tagName === "VIDEO" && a.setAttribute("playsinline", ""),
          r > 0 && a.load());
      }));
    ...
    if (s) {
      ...
      if (s.hasAttribute("data-loaded") === !1) {
        ...
        let h = e.getAttribute("data-background-image"),
        ...
        if (h)
          /^data:/.test(h.trim())
            ? (a.style.backgroundImage = `url(${h.trim()})`)
      ...
      e &&
        ...
        (E(e, "video, audio").forEach((t) => {
          !t.hasAttribute("data-ignore") &&
            ...
            (t.setAttribute("data-paused-by-reveal", ""), t.pause(), le && t.removeEventListener("canplay", this.ensureMobileMediaPlaying));
        }),
...
const de = ".slides section",
  te = ".slides>section",
  _e = ".slides>section.present>section",
  Pi = ".backgrounds>.slide-background",
  Li = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener|showPreview/,
  Ti = "h.v",
  xi = "h/v",
  Ye = "c",
  zt = "c/t";
...
class Bi {
  ...
  getContrastClass(e) {
    ...
    if (t) {
      const s = Ge(t);
      if (s && s.a !== 0) return Ni(t) < 128 ? "has-dark-background" : "has-light-background";
    }
    return null;
  }
  /**
    ...
    if (
      (Array.from(this.element.childNodes).forEach((u, g) => {
        (u.classList.remove("past", "present", "future"),
          ...
          (e || g === s.h) &&
            E(u, ".slide-background").forEach((y, p) => {
  ...
  updateParallax() {
    ...
    if (this.Reveal.getConfig().parallaxBackgroundImage) {
      ...
      (typeof this.Reveal.getConfig().parallaxBackgroundVertical == "number"
        ? (b = this.Reveal.getConfig().parallaxBackgroundVertical)
        : (b = (r - y) / (p - 1)),
        (l = p > 0 ? b * e.v : 0),
...
class Hi {
      ...
      if ((o && (e.style.display = "none"), i.dataset.autoAnimateUnmatched !== "false" && this.Reveal.getConfig().autoAnimateUnmatched === !0)) {
        ...
        (this.getUnmatchedAutoAnimateElements(i).forEach((y) => {
          ...
          ((p.duration !== r.duration || p.delay !== r.delay) &&
            ((b = "unmatched-" + Nt++),
            h.push(`[data-auto-animate="running"] [data-auto-animate-target="${b}"] { transition: opacity ${p.duration}s ease ${p.delay}s; }`)),
            (y.dataset.autoAnimateTarget = b));
        }, this),
          h.push(`[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity ${u}s ease ${g}s; }`));
      }
      ((this.autoAnimateStyleSheet.innerHTML = h.join("")),
  ...
  autoAnimateElements(e, i, t, s, a) {
    ...
    let o = this.getAutoAnimatableProperties("from", e, t),
      h = this.getAutoAnimatableProperties("to", i, t);
    ...
    let u = "",
      g = Object.keys(h.styles);
    if (g.length > 0) {
      ((o.styles.transition = "none"),
        (h.styles.transition = `all ${r.duration}s ${r.easing} ${r.delay}s`),
        (h.styles["transition-property"] = g.join(", ")),
        (h.styles["will-change"] = g.join(", ")));
      let y = Object.keys(o.styles)
          .map((b) => b + ": " + o.styles[b] + " !important;")
          .join(""),
        p = Object.keys(h.styles)
          .map((b) => b + ": " + h.styles[b] + " !important;")
          .join("");
      ...
      (t.styles || s.autoAnimateStyles).forEach((o) => {
        ...
        (typeof o == "string" && (o = { property: o }),
          typeof o.from != "undefined" && e === "from"
            ? (h = { value: o.from, explicitValue: !0 })
            : typeof o.to != "undefined" && e === "to"
              ? (h = { value: o.to, explicitValue: !0 })
              : (o.property === "line-height" && (h = parseFloat(r["line-height"]) / parseFloat(r["font-size"])), isNaN(h) && (h = r[o.property])),
          h !== "" && (a.styles[o.property] = h));
      }),
      a
    );
  }
      ...
      t.forEach((o) => {
        xe(o.from, a)
          ...
          : xe(o.from, "pre") &&
            ...
            this.findAutoAnimateMatches(t, o.from, o.to, ".hljs .hljs-ln-code", (h) => h.textContent, {
              scale: !1,
              styles: [],
...
class Oi {
  ...
  activate() {
    ...
    const i = E(this.Reveal.getRevealElement(), te),
      t = E(this.Reveal.getRevealElement(), Pi);
    ...
    const u = (g, y, p, b) => {
      ...
      if (h && this.Reveal.shouldAutoAnimateBetween(h, g))
        ((l = document.createElement("div")),
          ...
          h.closest(".scroll-page-content").parentNode.appendChild(l));
      else {
        ...
        ((M.className = "scroll-page-sticky"),
          A.appendChild(M),
          (l = document.createElement("div")),
    ...
    (i.forEach((g, y) => {
      this.Reveal.isVerticalStack(g)
        ? g.querySelectorAll("section").forEach((p, b) => {
            u(p, y, b, !0);
          })
        : u(g, y, 0);
    }, this),
      this.createProgressBar(),
      E(this.Reveal.getRevealElement(), ".stack").forEach((g) => g.remove()),
  ...
  syncPages() {
    ...
    ((this.pages = h.map((u) => {
      ...
      ((y += g.autoAnimatePages.reduce((p, b) => p + Math.max(b.scrollTriggers.length - 1, 0), g.autoAnimatePages.length)),
        g.pageElement.querySelectorAll(".scroll-snap-point").forEach((p) => p.remove()));
      for (let p = 0; p < y + 1; p++) {
        const b = document.createElement("div");
        ((b.className = "scroll-snap-point"),
          (b.style.height = this.scrollTriggerHeight + "px"),
          (b.style.scrollSnapAlign = s ? "center" : "start"),
          g.pageElement.appendChild(b),
          p === 0 && (b.style.marginTop = -this.scrollTriggerHeight + "px"));
      }
      return (
  ...
  syncProgressBar() {
    ...
    ((this.progressBarHeight = this.progressBarInner.offsetHeight),
      (this.playheadHeight = Math.max(t * this.progressBarHeight, zi)),
      ...
      s > Fi
        ? this.slideTriggers.forEach((r) => {
            ...
            ((o.progressBarSlide = document.createElement("div")),
              ...
              (o.scrollTriggerElements = o.scrollTriggers.map((h, u) => {
                const g = document.createElement("div");
                return (
                  (g.className = "scrollbar-trigger"),
                  (g.style.top = (h.range[0] - r.range[0]) * this.progressBarHeight + "px"),
                  (g.style.height = (h.range[1] - h.range[0]) * this.progressBarHeight - a + "px"),
  ...
  syncScrollPosition() {
    ...
    (this.slideTriggers.forEach((h) => {
      const { page: u } = h;
      (a >= h.range[0] - i * 2 && a <= h.range[1] + i * 2 && !u.loaded
        ...
        a >= h.range[0] && a <= h.range[1] ? (this.activateTrigger(h), (o = h.page)) : h.active && this.deactivateTrigger(h));
    }),
      o &&
        o.scrollTriggers.forEach((h) => {
...
class Ui {
  ...
  activate() {
    return It(this, null, function* () {
      const e = this.Reveal.getConfig(),
        i = E(this.Reveal.getRevealElement(), de),
      ...
      (yield new Promise(requestAnimationFrame),
        Xe("@page{size:" + a + "px " + r + "px; margin: 0px;}"),
        Xe(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: " + o + "px; max-height:" + h + "px}"),
      ...
      (i.forEach(function (A, M) {
        if (A.classList.contains("stack") === !1) {
          ...
          if (
            ...
            (R.style.height = (r + e.pdfPageHeightOffset) * z + "px"),
          ...
          if (e.pdfSeparateFragments) {
            ...
            (B.forEach(function (W, L) {
              ...
              if (t) {
                const F = k.querySelector(".slide-number-pdf"),
                  C = L + 1;
                F.innerHTML += "." + C;
              }
              (p.push(k), (q = W));
  ...
  activate() {
    if (this.Reveal.getConfig().overview && !this.Reveal.isScrollView() && !this.isActive()) {
      ((this.active = !0),
        ...
        E(this.Reveal.getRevealElement(), de).forEach((s) => {
  ...
  layout() {
    (this.Reveal.getHorizontalSlides().forEach((e, i) => {
      (e.setAttribute("data-index-h", i),
        ae(e, "translate3d(" + i * this.overviewSlideWidth + "px, 0, 0)"),
        e.classList.contains("stack") &&
          E(e, "section").forEach((t, s) => {
      ...
      Array.from(this.Reveal.getBackgroundsElement().childNodes).forEach((e, i) => {
        (ae(e, "translate3d(" + i * this.overviewSlideWidth + "px, 0, 0)"),
          E(e, ".slide-background").forEach((t, s) => {
            ae(t, "translate3d(0, " + s * this.overviewSlideHeight + "px, 0)");
          }));
      }));
  }
  ...
  deactivate() {
    if (this.Reveal.getConfig().overview) {
      ((this.active = !1),
        ...
        E(this.Reveal.getRevealElement(), de).forEach((i) => {
                    ...
                    : t === 35
                      ...
                      : t === 32
                        ...
                        : [58, 59, 66, 86, 190].includes(t) || (t === 191 && !e.shiftKey)
                          ...
                          : t === 70
                            ? Dt(i.embedded ? this.Reveal.getViewportElement() : document.documentElement)
                            : t === 65
  ...
  writeURL(e) {
    ...
    if ((clearTimeout(this.writeURLTimeout), typeof e == "number")) this.writeURLTimeout = setTimeout(this.writeURL, e);
      ...
      i.history
        ...
        : i.hash && (s === "/" ? this.debouncedReplaceState(window.location.pathname + window.location.search) : this.debouncedReplaceState("#" + s));
    }
  }
  replaceState(e) {
...
class _i {
  ...
  render() {
    ...
    ((this.element = document.createElement("aside")),
      ...
      this.Reveal.getRevealElement().appendChild(this.element),
      (this.controlsLeft = E(i, ".navigate-left")),
      (this.controlsRight = E(i, ".navigate-right")),
      (this.controlsUp = E(i, ".navigate-up")),
      (this.controlsDown = E(i, ".navigate-down")),
      (this.controlsPrev = E(i, ".navigate-prev")),
      (this.controlsNext = E(i, ".navigate-next")),
      (this.controlsFullscreen = E(i, ".enter-fullscreen")),
...
class Ji {
  ...
  onTouchMove(e) {
    ...
    let i = this.Reveal.getConfig();
    if (this.touchCaptured) Ft && e.preventDefault();
    else {
      this.Reveal.onUserInput(e);
        ...
        (r > Te && Math.abs(r) > Math.abs(o)
          ...
          : r < -Te && Math.abs(r) > Math.abs(o)
            ...
            : o > Te && a.up
              ...
              : o < -Te && a.down && ((this.touchCaptured = !0), i.navigationMode === "linear" ? this.Reveal.next() : this.Reveal.down()),
...
function Ut(c, e) {
  ...
  function _t() {
    ...
    (n || d) &&
      ...
      n ? (document.readyState === "complete" ? F.activate() : window.addEventListener("load", () => F.activate())) : k.activate());
  }
  function Je() {
    t.showHiddenSlides ||
  ...
  function $t() {
    (l.slides.classList.add("no-transition"),
      le ? l.wrapper.classList.add("no-hover") : l.wrapper.classList.remove("no-hover"),
      L.render(),
      B.render(),
      q.render(),
      X.render(),
      K.render(),
      _.render(),
      (l.pauseOverlay = wi(l.wrapper, "div", "pause-overlay", t.controls ? '<button class="resume-button">Resume presentation</button>' : null)),
      (l.statusElement = Xt()),
  ...
  function Ze(n) {
    ...
    (l.wrapper.classList.remove(d.transition),
      ...
      t.shuffle && De(),
      Ke(l.wrapper, "embedded", t.embedded),
      Ke(l.wrapper, "rtl", t.rtl),
      Ke(l.wrapper, "center", t.center),
      t.pause === !1 && ve(),
      W.reset(),
      O && (O.destroy(), (O = null)),
      v > 1 &&
        ...
        ((O = new es(l.wrapper, () => Math.min(Math.max((Date.now() - re) / M, 0), 1))), O.on("click", fi), (z = !1)),
  ...
  function et() {
    (window.addEventListener("resize", Pt, !1),
      ...
      X.bind(),
      ne.bind(),
      l.slides.addEventListener("click", Ct, !1),
      l.slides.addEventListener("transitionend", kt, !1),
      l.pauseOverlay.addEventListener("click", ve, !1),
      t.focusBodyOnPageVisibilityChange && document.addEventListener("visibilitychange", Lt, !1));
  }
  function be() {
    (Ie.unbind(),
      ne.unbind(),
      ...
      l.slides.removeEventListener("click", Ct, !1),
      l.slides.removeEventListener("transitionend", kt, !1),
      l.pauseOverlay.removeEventListener("click", ve, !1));
  }
  function Qt() {
    ((s = !1),
      a !== !1 &&
        ...
        B.destroy(),
        q.destroy(),
        document.removeEventListener("fullscreenchange", Pe),
        document.removeEventListener("webkitfullscreenchange", Pe),
        document.removeEventListener("visibilitychange", Lt, !1),
        window.removeEventListener("message", Rt, !1),
        ...
        Array.from(l.wrapper.querySelectorAll(de)).forEach((n) => {
  ...
  function Ne(n) {
    (typeof n.layout == "string" && (b.layout = n.layout),
      typeof n.overview == "string" && (b.overview = n.overview),
      b.layout ? ae(l.slides, b.layout + " " + b.overview) : ae(l.slides, b.overview));
  }
        ...
        (rt(t.width, t.height),
          ...
          p === 1 || k.isActive()
            ...
            : ((l.slides.style.zoom = ""),
              ...
              Ne({ layout: "translate(-50%, -50%) scale(" + p + ")" })));
        const w = Array.from(l.wrapper.querySelectorAll(de));
        for (let P = 0, x = w.length; P < x; P++) {
          const N = w[P];
          N.style.display !== "none" &&
            (t.center || N.classList.contains("center")
              ? N.classList.contains("stack")
                ? (N.style.top = 0)
                : (N.style.top = Math.max((v.height - N.scrollHeight) / 2, 0) + "px")
              : (N.style.top = ""));
        }
        m !== p &&
          j({
  ...
  function rt(n, d) {
    E(l.slides, "section > .stretch, section > .r-stretch").forEach((v) => {
      ...
      if (/(img|video)/gi.test(v.nodeName)) {
        const w = v.naturalWidth || v.videoWidth,
  ...
  function we(n, d) {
    ...
    return (
      (w.presentationWidth -= w.presentationWidth * t.margin),
      (w.presentationHeight -= w.presentationHeight * t.margin),
      typeof w.width == "string" && /%$/.test(w.width) && (w.width = (parseInt(w.width, 10) / 100) * w.presentationWidth),
      typeof w.height == "string" && /%$/.test(w.height) && (w.height = (parseInt(w.height, 10) / 100) * w.presentationHeight),
      w
    );
  }
  function nt(n, d) {
  ...
  function Y(n, d, v, m) {
    ...
    G || (h = null);
    let $ = P[r],
      I = $.querySelectorAll("section");
    (c.classList.toggle("is-vertical-slide", I.length > 1), (u = I[o] || $));
    let ee = !1;
    (G && h && u && !f.isActive() && ((A = "running"), (ee = He(h, u, N, oe)), ee && l.slides.classList.add("disable-slide-transitions")),
      Ve(),
      he(),
      f.isActive() && f.update(),
    ...
    (G && (R.afterSlideChanged(), st(m)),
      (G || !h) && (R.stopEmbeddedContent(h), R.startEmbeddedContent(u)),
      requestAnimationFrame(() => {
        Me(ye(u));
      }),
      K.update(),
  ...
  function ai(n, d, v) {
    ...
    ((h = u),
      (u = n),
      u && h && t.autoAnimate && He(h, u, m, o) && W.run(h, u),
      w &&
        (R.afterSlideChanged(),
        h && (R.stopEmbeddedContent(h), R.stopEmbeddedContent(h.slideBackgroundElement)),
  ...
  function ut() {
    (be(),
      ...
      typeof r != "undefined" && ((r = Ee(te, r)), (o = Ee(_e, o))),
      X.update(),
      K.update(),
      Ve(),
      _.update(),
    ...
    if (m) {
      ...
      for (let $ = 0; $ < m; $++) {
        ...
        if (
          ...
          I.querySelector("section") && I.classList.add("stack"),
          w)
        ) {
          I.classList.add("present");
          continue;
        ...
        $ < d
          ? (I.classList.add(ee ? "future" : "past"), t.fragments && ft(I))
          : $ > d
            ? (I.classList.add(ee ? "past" : "future"), t.fragments && gt(I))
            : $ === d && t.fragments && (P ? gt(I) : x && ft(I));
      }
      let N = v[d],
        oe = N.classList.contains("present");
  ...
  function Ve() {
    ...
    if (d && typeof r != "undefined") {
      ...
      (bt() ? l.wrapper.classList.add("has-vertical-slides") : l.wrapper.classList.remove("has-vertical-slides"),
        yt() ? l.wrapper.classList.add("has-horizontal-slides") : l.wrapper.classList.remove("has-horizontal-slides"));
    }
  }
  function Z({ includeFragments: n = !1 } = {}) {
    let d = l.wrapper.querySelectorAll(te),
      v = l.wrapper.querySelectorAll(_e),
      m = {
        left: r > 0,
        right: r < d.length - 1,
        up: o > 0,
    ...
    if ((Se(), u && t.autoSlide !== !1)) {
      ...
      (d
        ...
        M &&
          ...
          !me() &&
          !f.isActive() &&
          (!Be() || C.availableRoutes().next || t.loop === !0) &&
          ((U = setTimeout(() => {
  ...
  function ke({ skipFragments: n = !1 } = {}) {
    ...
    t.rtl
      ? (f.isActive() || n || C.next() === !1) && Z().left && Y(r + 1, t.navigationMode === "grid" ? o : void 0)
      : (f.isActive() || n || C.prev() === !1) && Z().left && Y(r - 1, t.navigationMode === "grid" ? o : void 0);
  }
  function Ce({ skipFragments: n = !1 } = {}) {
    if (((g.hasNavigatedHorizontally = !0), k.isActive())) return k.next();
    t.rtl
      ? (f.isActive() || n || C.prev() === !1) && Z().right && Y(r - 1, t.navigationMode === "grid" ? o : void 0)
      : (f.isActive() || n || C.next() === !1) && Z().right && Y(r + 1, t.navigationMode === "grid" ? o : void 0);
  }
  ...
  function Ue({ skipFragments: n = !1 } = {}) {
    ...
    if (n || C.next() === !1) {
      let d = Z();
      (d.down && d.right && t.loop && lt() && (d.down = !1),
        d.down ? Oe({ skipFragments: n }) : t.rtl ? ke({ skipFragments: n }) : Ce({ skipFragments: n }));
    }
  }
  function ui(n) {
