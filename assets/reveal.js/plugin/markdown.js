(function (L, E) {
  typeof exports == "object" && typeof module < "u"
    ...
    : typeof define == "function" && define.amd
      ? define(E)
      : ((L = typeof globalThis < "u" ? globalThis : L || self), (L.RevealMarkdown = E()));
})(this, function () {
  "use strict";
  function L() {
    return {
  ...
  var ye = (() => {
    ...
    Fe = m(ue, "u").replace(/punct/g, O).getRegex(),
    Ue = m(ue, "u").replace(/punct/g, pe).getRegex(),
    ge =
    ...
    fe = m(/^!?\[(ref)\](?:\[\])?/)
      .replace("ref", X)
      .getRegex(),
    st = m("reflink|nolink(?!\\()", "g").replace("reflink", de).replace("nolink", fe).getRegex(),
    ke = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
    K = {
      _backpedal: I,
      anyPunctuation: Ye,
      autolink: et,
    ...
    Y = {
      ...
      delLDelim: Ve,
      delRDelim: Ke,
      url: m(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/)
        .replace("protocol", ke)
    ...
    it = {
      ...Y,
      br: m(oe).replace("{2,}", "*").getRegex(),
      text: m(Y.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
    },
    Z = { normal: V, gfm: Ce, pedantic: qe },
    B = { normal: K, gfm: Y, breaks: it, pedantic: lt },
    at = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
    xe = (t) => at[t];
  function z(t, e) {
    if (e) {
      if (T.escapeTest.test(t)) return t.replace(T.escapeReplace, xe);
    } else if (T.escapeTestNoEncode.test(t)) return t.replace(T.escapeReplaceNoEncode, xe);
    return t;
  }
  function be(t) {
    try {
  ...
  function me(t, e) {
    let n = t.replace(T.findPipe, (i, l, c) => {
        let a = !1,
          u = l;
        for (; --u >= 0 && c[u] === "\\"; ) a = !a;
        return a ? "|" : " |";
      }),
      s = n.split(T.splitPipe),
      r = 0;
  ...
  function we(t, e, n, s, r) {
    let i = e.href,
      l = e.title || null,
      c = t[1].replace(r.other.outputLinkReplace, "$1");
    s.state.inLink = !0;
    let a = { type: t[0].charAt(0) === "!" ? "image" : "link", raw: n, href: i, title: l, text: c, tokens: s.inlineTokens(c) };
...
`),
          ...
          for (; n.length > 0; ) {
            ...
            for (a = 0; a < n.length; a++)
              if (this.rules.other.blockquoteStart.test(n[a])) (c.push(n[a]), (l = !0));
              else if (!l) c.push(n[a]);
              else break;
            n = n.slice(a);
            let u = c.join(`
`),
...
${h}`
            ...
            if (((this.lexer.state.top = !0), this.lexer.blockTokens(h, i, !0), (this.lexer.state.top = x), n.length === 0)) break;
            let f = i.at(-1);
...
`),
                g = this.list(o);
              ((i[i.length - 1] = g),
                (s = s.substring(0, s.length - f.raw.length) + g.raw),
                (r = r.substring(0, r.length - p.raw.length) + g.raw),
                (n = o.substring(i.at(-1).raw.length).split(`
`)));
              continue;
            }
          }
...
`,
            ...
            if (
              (this.options.pedantic
                ...
                : p
                  ? (o = e[1].length + 1)
                  : ((o = x.search(this.rules.other.nonSpaceChar)), (o = o > 4 ? 1 : o), (h = x.slice(o)), (o += e[1].length)),
              p &&
...
`),
              ...
              let g = this.rules.other.nextBulletRegex(o),
                d = this.rules.other.hrRegex(o),
                R = this.rules.other.fencesBeginRegex(o),
                k = this.rules.other.headingBeginRegex(o),
                b = this.rules.other.htmlBeginRegex(o),
                w = this.rules.other.blockquoteBeginRegex(o);
              for (; t; ) {
                let $ = t.split(
                    `
`,
                ...
                if (
                  ((f = $),
                  this.options.pedantic
                    ? ((f = f.replace(this.rules.other.listReplaceNesting, "  ")), (y = f))
                    : (y = f.replace(this.rules.other.tabCharGlobal, "    ")),
                  R.test(f) || k.test(f) || b.test(f) || w.test(f) || g.test(f) || d.test(f))
                )
                  break;
                if (y.search(this.rules.other.nonSpaceChar) >= o || !f.trim())
                  h +=
                    `
` + y.slice(o);
                else {
                  if (
                    p ||
                    x.replace(this.rules.other.tabCharGlobal, "    ").search(this.rules.other.nonSpaceChar) >= 4 ||
                    R.test(x) ||
                    k.test(x) ||
                    d.test(x)
                  )
...
`),
            ...
            (r.loose || (l ? (r.loose = !0) : this.rules.other.doubleBlankLine.test(u) && (l = !0)),
              r.items.push({
                type: "list_item",
                raw: u,
          ...
          for (let a of r.items) {
            if (((this.lexer.state.top = !1), (a.tokens = this.lexer.blockTokens(a.text, [])), a.task)) {
              if (
                ((a.text = a.text.replace(this.rules.other.listReplaceTask, "")), a.tokens[0]?.type === "text" || a.tokens[0]?.type === "paragraph")
              ) {
              ...
              if (u) {
                ...
                ((a.checked = h.checked),
                  r.loose
                    ? a.tokens[0] && ["paragraph", "text"].includes(a.tokens[0].type) && "tokens" in a.tokens[0] && a.tokens[0].tokens
                      ? ((a.tokens[0].raw = h.raw + a.tokens[0].raw), (a.tokens[0].text = h.raw + a.tokens[0].text), a.tokens[0].tokens.unshift(h))
                      : a.tokens.unshift({ type: "paragraph", raw: h.raw, text: h.raw, tokens: [h] })
                    : a.tokens.unshift(h));
              }
            }
            if (!r.loose) {
              let u = a.tokens.filter((x) => x.type === "space"),
                h = u.length > 0 && u.some((x) => this.rules.other.anyLine.test(x.raw));
              r.loose = h;
            }
          }
          if (r.loose)
...
`)
        ...
        if (n.length === s.length) {
          ...
          for (let l of r)
            i.rows.push(me(l, i.header.length).map((c, a) => ({ text: c, tokens: this.lexer.inline(c), header: !1, align: i.align[a] })));
          return i;
        }
      }
      lheading(t) {
...
`
      ...
      link(t) {
        ...
        if (e) {
          ...
          return (
            ...
            we(
              e,
              { href: s && s.replace(this.rules.inline.anyPunctuation, "$1"), title: r && r.replace(this.rules.inline.anyPunctuation, "$1") },
              e[0],
              this.lexer,
              this.rules
            )
      ...
      del(t, e, n = "") {
        ...
        if (s && (!s[1] || !n || this.rules.inline.punctuation.exec(n))) {
          ...
          for (a.lastIndex = 0, e = e.slice(-1 * t.length + r); (s = a.exec(e)) != null; ) {
    ...
    _ = class te {
      ...
      constructor(e) {
        ...
        let n = { other: T, block: Z.normal, inline: B.normal };
        (this.options.pedantic
          ? ((n.block = Z.pedantic), (n.inline = B.pedantic))
          : this.options.gfm && ((n.block = Z.gfm), this.options.breaks ? (n.inline = B.breaks) : (n.inline = B.gfm)),
      ...
      static lex(e, n) {
        return new te(n).lex(e);
      }
      static lexInline(e, n) {
        return new te(n).inlineTokens(e);
      }
      lex(e) {
        ((e = e.replace(
          T.carriageReturn,
...
`
      ...
      blockTokens(e, n = [], s = !1) {
        for (this.options.pedantic && (e = e.replace(T.tabCharGlobal, "    ").replace(T.spaceLine, "")); e; ) {
          let r;
          if (
            this.options.extensions?.block?.some((l) => ((r = l.call({ lexer: this }, e, n)) ? ((e = e.substring(r.raw.length)), n.push(r), !0) : !1))
          )
            continue;
...
` + r.raw),
                (this.inlineQueue.at(-1).src = l.text))
              : this.tokens.links[r.tag] || ((this.tokens.links[r.tag] = { href: r.href, title: r.title }), n.push(r));
            continue;
          }
          ...
          if (this.options.extensions?.startBlock) {
            ...
            (this.options.extensions.startBlock.forEach((u) => {
              ((a = u.call({ lexer: this }, c)), typeof a == "number" && a >= 0 && (l = Math.min(l, a)));
            }),
...
` + r.text),
      ...
      inlineTokens(e, n = []) {
          ...
          if (a.length > 0)
            for (; (r = this.tokenizer.rules.inline.reflinkSearch.exec(s)) != null; )
              a.includes(r[0].slice(r[0].lastIndexOf("[") + 1, -1)) &&
                (s = s.slice(0, r.index) + "[" + "a".repeat(r[0].length - 2) + "]" + s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
        }
        ...
        for (; (r = this.tokenizer.rules.inline.blockSkip.exec(s)) != null; )
          ((i = r[2] ? r[2].length : 0),
            (s = s.slice(0, r.index + i) + "[" + "a".repeat(r[0].length - i - 2) + "]" + s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex)));
        ...
        for (; e; ) {
          ...
          if (
            this.options.extensions?.inline?.some((h) =>
              (a = h.call({ lexer: this }, e, n)) ? ((e = e.substring(a.raw.length)), n.push(a), !0) : !1
            )
          )
            continue;
          ...
          if ((a = this.tokenizer.reflink(e, this.tokens.links))) {
            ...
            let h = n.at(-1);
            a.type === "text" && h?.type === "text" ? ((h.raw += a.raw), (h.text += a.text)) : n.push(a);
            continue;
          }
          ...
          if ((a = this.tokenizer.inlineText(u))) {
            ...
            let h = n.at(-1);
            h?.type === "text" ? ((h.raw += a.raw), (h.text += a.text)) : n.push(a);
            continue;
          }
          if (e) {
    ...
    j = class {
      ...
      code({ text: t, lang: e, escaped: n }) {
        let s = (e || "").match(T.notSpaceStart)?.[0],
          r =
            t.replace(T.endingNewline, "") +
            `
`;
        return s
      ...
      parse(e) {
        ...
        for (let s = 0; s < e.length; s++) {
          ...
          if (this.options.extensions?.renderers?.[r.type]) {
            let l = r,
              c = this.options.extensions.renderers[l.type].call({ parser: this }, l);
    ...
    Se = class {
        ...
        for (let s of t)
          switch (((n = n.concat(e.call(this, s))), s.type)) {
            case "table": {
              ...
              for (let i of r.rows) for (let l of i) n = n.concat(this.walkTokens(l.tokens, e));
              break;
            }
            case "list": {
              let r = s;
          ...
          t.forEach((n) => {
            ...
            if (
                    ...
                    (i ? i.unshift(r.tokenizer) : (e[r.level] = [r.tokenizer]),
                      r.start &&
                        (r.level === "block"
                          ...
                          : r.level === "inline" && (e.startInline ? e.startInline.push(r.start) : (e.startInline = [r.start]))));
                  }
              ...
              for (let i in n.renderer) {
                ...
                r[l] = (...u) => {
                  let h = c.apply(r, u);
                  return (h === !1 && (h = a.apply(r, u)), h || "");
                };
              }
              s.renderer = r;
            }
            if (n.tokenizer) {
              let r = this.defaults.tokenizer || new Q(this.defaults);
            ...
            if (n.hooks) {
              ...
              for (let i in n.hooks) {
                ...
                let l = i,
                  c = n.hooks[l],
                  a = r[l];
                D.passThroughHooks.has(i)
                  ? (r[l] = (u) => {
                      if (this.defaults.async && D.passThroughHooksRespectAsync.has(i))
                        return (async () => {
                  ...
                  : (r[l] = (...u) => {
                      if (this.defaults.async)
                        return (async () => {
                          ...
                          return (x === !1 && (x = await a.apply(r, u)), x);
                        })();
                      let h = c.apply(r, u);
                      return (h === !1 && (h = a.apply(r, u)), h);
                    });
      ...
      parseMarkdown(t) {
        return (e, n) => {
          ...
          if ((r.hooks && ((r.hooks.options = r), (r.hooks.block = t)), r.async))
            return (async () => {
              let l = r.hooks ? await r.hooks.preprocess(e) : e,
                c = await (r.hooks ? await r.hooks.provideLexer() : t ? _.lex : _.lexInline)(l, r),
                a = r.hooks ? await r.hooks.processAllTokens(c) : c;
              r.walkTokens && (await Promise.all(this.walkTokens(a, r.walkTokens)));
              let u = await (r.hooks ? await r.hooks.provideParser() : t ? v.parse : v.parseInline)(a, r);
              return r.hooks ? await r.hooks.postprocess(u) : u;
            })().catch(i);
          try {
            r.hooks && (e = r.hooks.preprocess(e));
            let l = (r.hooks ? r.hooks.provideLexer() : t ? _.lex : _.lexInline)(e, r);
            (r.hooks && (l = r.hooks.processAllTokens(l)), r.walkTokens && this.walkTokens(l, r.walkTokens));
            let c = (r.hooks ? r.hooks.provideParser() : t ? v.parse : v.parseInline)(l, r);
...
Please report this to https://github.com/markedjs/marked.`),
  ...
  ((S.options = S.setOptions =
    function (t) {
      return (C.setOptions(t), (S.defaults = C.defaults), ne(S.defaults), S);
    }),
    (S.getDefaults = L),
    (S.defaults = E),
    (S.use = function (...t) {
      return (C.use(...t), (S.defaults = C.defaults), ne(S.defaults), S);
    }),
    (S.walkTokens = function (t, e) {
      return C.walkTokens(t, e);
    }),
    (S.parseInline = C.parseInline),
    (S.Parser = v),
    (S.parser = v.parse),
    (S.Renderer = j),
    (S.TextRenderer = ee),
    ...
    v.parse,
    _.lex);
  const ht = /<(\/?)(?:pre|code|kbd|script|math)[^>]*>/i,
    ut = (t = "", e = "1") => {
      var n,
        s,
        r,
        ...
        l,
        c = 0;
      if ((typeof e == "number" ? (e = e.toString()) : (e = e.replace(/\s/g, "")), e === "0")) return t;
      if (e === "1") ((n = 1), (s = 1), (r = 1), (i = 1));
      else if (e === "2") ((n = 1), (s = 1), (r = 2), (i = 1));
      else if (e === "3") ((n = 1), (s = 1), (r = 3), (i = 1));
      else if (e === "-1") l = 1;
      else
      ...
      for (let f = 0; f < a.length; f++) {
        ...
        if (p[0] === "tag") {
          ...
          let o = p[1],
            g = o.substring(o.length - 1, o.length);
          (h ||
            ((o = St(o)),
            c && (o = o.replace(/$quot;/g, '"')),
            r && (r === 1 && (o = kt(o)), r === 2 && (o = xt(o)), r === 3 && (o = bt(o))),
            i && (o = mt(o)),
            s && ((o = dt(o)), s === 2 && (o = ft(o))),
            n &&
              (o === "'"
    ...
    gt = (t) => {
      ...
      var n = "[^\\ \\t\\r\\n\\[\\{\\(\\-]",
        ...
        r = "&#8211;|&#8212;";
      return (
        (t = t.replace(new RegExp(`(\\s|&nbsp;|--|&[mn]dash;|${r}|&#x201[34])'(?=\\w)`, "g"), "$1&#8216;")),
        (t = t.replace(new RegExp(`(${n})'`, "g"), "$1&#8217;")),
        (t = t.replace(new RegExp(`(${s}?)'(?=\\s|s\\b)`, "g"), "$1&#8217;")),
        (t = t.replace(/'/g, "&#8216;")),
        (t = t.replace(new RegExp(`(\\s|&nbsp;|--|&[mn]dash;|${r}|&#x201[34])"(?=\\w)`, "g"), "$1&#8220;")),
        (t = t.replace(new RegExp(`(${n})"`, "g"), "$1&#8221;")),
        (t = t.replace(new RegExp(`(${s}?)"(?=\\s)`, "g"), "$1&#8221;")),
        (t = t.replace(/"/g, "&#8220;")),
        t
      );
    },
    dt = (t) => ((t = t.replace(/``/g, "&#8220;")), (t = t.replace(/''/g, "&#8221;")), t),
    ft = (t) => ((t = t.replace(/`/g, "&#8216;")), (t = t.replace(/'/g, "&#8217;")), t),
    kt = (t) => ((t = t.replace(/--/g, "&#8212;")), t),
    xt = (t) => ((t = t.replace(/---/g, "&#8212;")), (t = t.replace(/--/g, "&#8211;")), t),
    bt = (t) => ((t = t.replace(/---/g, "&#8211;")), (t = t.replace(/--/g, "&#8212;")), t),
    mt = (t) => ((t = t.replace(/\.\.\./g, "&#8230;")), (t = t.replace(/\. \. \./g, "&#8230;")), t),
    wt = (t) => (
      (t = t.replace(/&#8211;/g, "-")),
      (t = t.replace(/&#8212;/g, "--")),
      (t = t.replace(/&#8216;/g, "'")),
    ...
    Rt = (t) => {
      for (var e = 0, n = t.length, s = [], r = /<!--[\s\S]*?-->|<\?.*?\?>|<[^>]*>/g, i = null; (i = r.exec(t)); ) {
        if (e < i.index) {
          let c = ["text", t.substring(e, i.index)];
          s.push(c);
        }
        let l = ["tag", i.toString()];
  ...
  function yt({ config: t = 2 } = {}) {
    return {
      tokenizer: {
        inlineText(e) {
          const n = this.rules.inline.text.exec(e);
          if (n) return { type: "text", raw: n[0], text: n[0], escaped: !0 };
        },
      },
      hooks: {
        postprocess(e) {
...
`,
  ...
  return () => {
    ...
    function n(p) {
      ...
      g = g.replace(new RegExp(Re, "g"), "<\/script>");
      const d = g.match(/^\n?(\s*)/)[1].length,
        R = g.match(/^\n?(\t*)/)[1].length;
      return (
        R > 0
...
` + b
    ...
    function r(p) {
      ...
      return (
        (p = p || {}),
        (p.separator = p.separator || o?.separator || $t),
        (p.verticalSeparator = p.verticalSeparator || o?.verticalSeparator || Tt),
        (p.notesSeparator = p.notesSeparator || o?.notesSeparator || At),
    ...
    function i(p, o) {
      ...
      return (
        g.length === 2 && e && (p = g[0] + '<aside class="notes">' + e.parse(g[1].trim()) + "</aside>"),
        (p = p.replace(/<\/script>/g, Re)),
        '<script type="text/template">' + p + "<\/script>"
      );
    }
    function l(p, o) {
      o = r(o);
      const g = new RegExp(o.separator + (o.verticalSeparator ? "|" + o.verticalSeparator : ""), "mg"),
        d = new RegExp(o.separator);
      let R,
        k = 0,
        b,
        w = !0,
      ...
      for (; (R = g.exec(p)); )
        ((b = d.test(R[0])),
          !b && w && y.push([]),
          ($ = p.substring(k, R.index)),
          b && w ? y.push($) : y[y.length - 1].push($),
          (k = g.lastIndex),
          (w = b));
      (w ? y : y[y.length - 1]).push(p.substring(k));
      let A = "";
      for (let P = 0, zt = y.length; P < zt; P++)
        y[P] instanceof Array
          ? ((A += "<section " + o.attributes + ">"),
            y[P].forEach(function (Pt) {
              A += "<section data-markdown>" + i(Pt, o) + "</section>";
            }),
            (A += "</section>"))
          : (A += "<section " + o.attributes + " data-markdown>" + i(y[P], o) + "</section>");
      return A;
    }
    function c(p) {
    ...
    function a(p) {
      return new Promise(function (o, g) {
        const d = new XMLHttpRequest(),
          R = p.getAttribute("data-markdown"),
          k = p.getAttribute("data-charset");
        (k !== null && k !== "" && d.overrideMimeType("text/html; charset=" + k),
          (d.onreadystatechange = function (b, w) {
    ...
    function h(p, o, g, d, R) {
      if (o !== null && o.childNodes !== void 0 && o.childNodes.length > 0) {
        ...
        for (let b = 0; b < o.childNodes.length; b++) {
          ...
          let $ = p;
          (w.nodeName === "section" && (($ = w), (k = w)),
            (typeof w.setAttribute == "function" || w.nodeType === Node.COMMENT_NODE) && h($, w, k, d, R));
        }
      }
    ...
    function x() {
      ...
      return (
        [].slice.call(p).forEach(function (o) {
          o.setAttribute("data-markdown-parsed", !0);
          const g = o.querySelector("aside.notes"),
            d = n(o);
          ((o.innerHTML = e ? e.parse(d) : d),
            h(
              o,
              o,
              null,
              o.getAttribute("data-element-attributes") || o.parentNode.getAttribute("data-element-attributes") || Et,
              o.getAttribute("data-attributes") || o.parentNode.getAttribute("data-attributes") || _t
            ),
            g && o.appendChild(g));
        }),
        Promise.resolve()
      ...
      init: function (p) {
        ...
        const k = o || {
          code({ text: b, lang: w }) {
            ...
            if (F.test($)) {
              let P = $.match(F)[2];
              (P && (y = `data-ln-start-from="${P.trim()}"`),
                (A = $.match(F)[3].trim()),
                (A = `data-line-numbers="${A}"`),
                ($ = $.replace(F, "").trim()));
            }
