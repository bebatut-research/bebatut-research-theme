...
var Te = (() => {
  ...
  Ge = m(be, "u").replace(/punct/g, j).getRegex(),
  Xe = m(be, "u").replace(/punct/g, ke).getRegex(),
  me =
  ...
  Se = m(/^!?\[(ref)\](?:\[\])?/)
    .replace("ref", J)
    .getRegex(),
  at = m("reflink|nolink(?!\\()", "g").replace("reflink", we).replace("nolink", Se).getRegex(),
  ...
  ot = {
    ...F,
    br: m(de).replace("{2,}", "*").getRegex(),
    text: m(F.text)
      .replace("\\b_", "\\b_| {2,}\\n")
      .replace(/\{2,\}/g, "*")
      .getRegex(),
  },
  D = { normal: Y, gfm: Be, pedantic: Me },
  C = { normal: te, gfm: F, breaks: ot, pedantic: it },
  ct = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
  le = (t) => ct[t];
function z(t, e) {
  if (e) {
...
`),
        ...
        for (; n.length > 0; ) {
          ...
          for (i = 0; i < n.length; i++)
            if (this.rules.other.blockquoteStart.test(n[i])) (c.push(n[i]), (l = !0));
...
`),
            ...
            ((a[a.length - 1] = g),
              ...
              (n = o.substring(a.at(-1).raw.length).split(`
`)));
            continue;
          }
        }
...
`),
        ...
        for (let i of r.items) {
          if (((this.lexer.state.top = !1), (i.tokens = this.lexer.blockTokens(i.text, [])), i.task)) {
            if (
              ((i.text = i.text.replace(this.rules.other.listReplaceTask, "")), i.tokens[0]?.type === "text" || i.tokens[0]?.type === "paragraph")
            ) {
              ((i.tokens[0].raw = i.tokens[0].raw.replace(this.rules.other.listReplaceTask, "")),
                (i.tokens[0].text = i.tokens[0].text.replace(this.rules.other.listReplaceTask, "")));
            ...
            if (u) {
              ...
              ((i.checked = h.checked),
                r.loose
                  ? i.tokens[0] && ["paragraph", "text"].includes(i.tokens[0].type) && "tokens" in i.tokens[0] && i.tokens[0].tokens
                    ? ((i.tokens[0].raw = h.raw + i.tokens[0].raw), (i.tokens[0].text = h.raw + i.tokens[0].text), i.tokens[0].tokens.unshift(h))
                    : i.tokens.unshift({ type: "paragraph", raw: h.raw, text: h.raw, tokens: [h] })
                  : i.tokens.unshift(h));
            }
          }
          if (!r.loose) {
            let u = i.tokens.filter((x) => x.type === "space"),
...
`)
      ...
      if (n.length === s.length) {
        ...
        for (let l of r)
          a.rows.push(ie(l, a.header.length).map((c, i) => ({ text: c, tokens: this.lexer.inline(c), header: !1, align: a.align[i] })));
        return a;
      }
    }
    lheading(t) {
...
`
  ...
  E = class U {
    ...
    constructor(e) {
      ...
      (this.options.pedantic
        ? ((n.block = D.pedantic), (n.inline = C.pedantic))
        : this.options.gfm && ((n.block = D.gfm), this.options.breaks ? (n.inline = C.breaks) : (n.inline = C.gfm)),
...
` + r.text),
    ...
    inlineTokens(e, n = []) {
      ...
      if (this.tokens.links) {
        ...
        if (i.length > 0)
          for (; (r = this.tokenizer.rules.inline.reflinkSearch.exec(s)) != null; )
            i.includes(r[0].slice(r[0].lastIndexOf("[") + 1, -1)) &&
      ...
      for (; (r = this.tokenizer.rules.inline.blockSkip.exec(s)) != null; )
        ((a = r[2] ? r[2].length : 0),
          (s = s.slice(0, r.index + a) + "[" + "a".repeat(r[0].length - a - 2) + "]" + s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex)));
      ...
      for (; e; ) {
        ...
        let i;
        if (
          this.options.extensions?.inline?.some((h) => ((i = h.call({ lexer: this }, e, n)) ? ((e = e.substring(i.raw.length)), n.push(i), !0) : !1))
        )
          continue;
          ...
          if (n.hooks) {
            ...
            for (let a in n.hooks) {
              ...
              let l = a,
                c = n.hooks[l],
                i = r[l];
              B.passThroughHooks.has(a)
                ? (r[l] = (u) => {
                    if (this.defaults.async && B.passThroughHooksRespectAsync.has(a))
                      return (async () => {
        ...
        if ((r.hooks && ((r.hooks.options = r), (r.hooks.block = t)), r.async))
          return (async () => {
            let l = r.hooks ? await r.hooks.preprocess(e) : e,
              c = await (r.hooks ? await r.hooks.provideLexer() : t ? E.lex : E.lexInline)(l, r),
              i = r.hooks ? await r.hooks.processAllTokens(c) : c;
...
_.parse;
E.lex;
const gt = /<(\/?)(?:pre|code|kbd|script|math)[^>]*>/i,
  dt = (t = "", e = "1") => {
    var n,
      s,
      r,
    ...
    if (e === "1") ((n = 1), (s = 1), (r = 1), (a = 1));
    else if (e === "2") ((n = 1), (s = 1), (r = 2), (a = 1));
    else if (e === "3") ((n = 1), (s = 1), (r = 3), (a = 1));
    else if (e === "-1") l = 1;
    else
    ...
    for (let f = 0; f < i.length; f++) {
      ...
      if (p[0] === "tag") {
        ...
        (h ||
          ...
          r && (r === 1 && (o = bt(o)), r === 2 && (o = mt(o)), r === 3 && (o = wt(o))),
          a && (o = St(o)),
          s && ((o = kt(o)), s === 2 && (o = xt(o))),
          n &&
            (o === "'"
  ...
  kt = (t) => ((t = t.replace(/``/g, "&#8220;")), (t = t.replace(/''/g, "&#8221;")), t),
  xt = (t) => ((t = t.replace(/`/g, "&#8216;")), (t = t.replace(/'/g, "&#8217;")), t),
  bt = (t) => ((t = t.replace(/--/g, "&#8212;")), t),
  mt = (t) => ((t = t.replace(/---/g, "&#8212;")), (t = t.replace(/--/g, "&#8211;")), t),
  wt = (t) => ((t = t.replace(/---/g, "&#8211;")), (t = t.replace(/--/g, "&#8212;")), t),
  St = (t) => ((t = t.replace(/\.\.\./g, "&#8230;")), (t = t.replace(/\. \. \./g, "&#8230;")), t),
  Rt = (t) => (
    (t = t.replace(/&#8211;/g, "-")),
    (t = t.replace(/&#8212;/g, "--")),
    (t = t.replace(/&#8216;/g, "'")),
...
` + b
    ...
    function r(p) {
      ...
      return (
        (p = p || {}),
        (p.separator = p.separator || o?.separator || At),
        (p.verticalSeparator = p.verticalSeparator || o?.verticalSeparator || Et),
        (p.notesSeparator = p.notesSeparator || o?.notesSeparator || _t),
