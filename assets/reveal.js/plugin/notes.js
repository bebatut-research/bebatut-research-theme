(function ($, v) {
  typeof exports == "object" && typeof module < "u"
    ...
    : typeof define == "function" && define.amd
      ? define(v)
      : (($ = typeof globalThis < "u" ? globalThis : $ || self), ($.RevealNotes = v()));
})(this, function () {
  "use strict";
  const $ = `<!--
...
<html lang="en">
  ...
  var kt = (() => {
    ...
    qt = /(?![*_])[\s\p{P}\p{S}]/u,
    Nt = /(?:[^\s\p{P}\p{S}]|[*_])/u,
    Dt = d(/link|precode-code|html/, "g")
      .replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/)
      .replace("precode-", kt ? "(?<!`)()" : "(^^|[^`])")
      .replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/)
      .replace("html", /<(?! )[^<>]*?>/)
      .getRegex(),
    at = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/,
    Bt = d(at, "u").replace(/punct/g, _).getRegex(),
    Ot = d(at, "u").replace(/punct/g, st).getRegex(),
    lt =
      "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",
    Ht = d(lt, "gu")
      .replace(/notPunctSpace/g, rt)
      .replace(/punctSpace/g, j)
      .replace(/punct/g, _)
      .getRegex(),
    Zt = d(lt, "gu")
      .replace(/notPunctSpace/g, Mt)
    ...
    Jt = d(Wt, "gu")
      ...
      .replace(/punctSpace/g, qt)
      .replace(/punct/g, it)
      .getRegex(),
    Qt = d(/\\(punct)/, "gu")
      .replace(/punct/g, _)
      .getRegex(),
    Kt = d(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/)
    ...
    ct = d(/^!?\[(ref)\](?:\[\])?/)
      .replace("ref", H)
      .getRegex(),
    Yt = d("reflink|nolink(?!\\()", "g").replace("reflink", ot).replace("nolink", ct).getRegex(),
    pt = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,
    W = {
      _backpedal: R,
      anyPunctuation: Qt,
      autolink: Kt,
    ...
    te = {
      ...J,
      br: d(nt).replace("{2,}", "*").getRegex(),
      text: d(J.text)
        .replace("\\b_", "\\b_| {2,}\\n")
        .replace(/\{2,\}/g, "*")
        .getRegex(),
    },
    q = { normal: U, gfm: Et, pedantic: zt },
    z = { normal: W, gfm: J, breaks: te, pedantic: Ft },
    ee = { "&": "&amp;", "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;" },
    ut = (r) => ee[r];
  function y(r, t) {
    if (t) {
      if (b.escapeTest.test(r)) return r.replace(b.escapeReplace, ut);
    } else if (b.escapeTestNoEncode.test(r)) return r.replace(b.escapeReplaceNoEncode, ut);
    return r;
  }
  function ht(r) {
    try {
  ...
  function gt(r, t, n, s, e) {
    let a = t.href,
      i = t.title || null,
      o = r[1].replace(e.other.outputLinkReplace, "$1");
    s.state.inLink = !0;
...
`),
          ...
          for (; n.length > 0; ) {
            ...
            for (l = 0; l < n.length; l++)
              if (this.rules.other.blockquoteStart.test(n[l])) (o.push(n[l]), (i = !0));
...
`),
                k = this.list(f);
              ((a[a.length - 1] = k),
                (s = s.substring(0, s.length - p.raw.length) + k.raw),
                (e = e.substring(0, e.length - g.raw.length) + k.raw),
...
`)));
      ...
      list(r) {
        ...
        if (t) {
          let n = t[1].trim(),
            s = n.length > 1,
            e = { type: "list", raw: "", ordered: s, start: s ? +n.slice(0, -1) : "", loose: !1, items: [] };
...
`,
            ...
            if (
              (this.options.pedantic
                ...
                : g
                  ? (f = t[1].length + 1)
                  : ((f = h.search(this.rules.other.nonSpaceChar)), (f = f > 4 ? 1 : f), (c = h.slice(f)), (f += t[1].length)),
              g &&
...
`),
              ...
              let k = this.rules.other.nextBulletRegex(f),
                S = this.rules.other.hrRegex(f),
                ft = this.rules.other.fencesBeginRegex(f),
                mt = this.rules.other.headingBeginRegex(f),
                ae = this.rules.other.htmlBeginRegex(f),
                le = this.rules.other.blockquoteBeginRegex(f);
              for (; r; ) {
                let K = r.split(
                    `
`,
                ...
                if (
                  ((p = K),
                  this.options.pedantic
                    ? ((p = p.replace(this.rules.other.listReplaceNesting, "  ")), (I = p))
                    : (I = p.replace(this.rules.other.tabCharGlobal, "    ")),
                  ft.test(p) || mt.test(p) || ae.test(p) || le.test(p) || k.test(p) || S.test(p))
                )
                  break;
                if (I.search(this.rules.other.nonSpaceChar) >= f || !p.trim())
                  c +=
                    `
` + I.slice(f);
                else {
...
` + p;
                ...
                ((g = !p.trim()),
                  (u +=
                    ...
                    `
`),
                  (r = r.substring(K.length + 1)),
                  (h = I.slice(f)));
              }
            }
            (e.loose || (i ? (e.loose = !0) : this.rules.other.doubleBlankLine.test(u) && (i = !0)),
              e.items.push({
                type: "list_item",
                raw: u,
          ...
          for (let l of e.items) {
            if (((this.lexer.state.top = !1), (l.tokens = this.lexer.blockTokens(l.text, [])), l.task)) {
              if (
                ((l.text = l.text.replace(this.rules.other.listReplaceTask, "")), l.tokens[0]?.type === "text" || l.tokens[0]?.type === "paragraph")
              ) {
                ...
                ((l.checked = c.checked),
                  e.loose
                    ? l.tokens[0] && ["paragraph", "text"].includes(l.tokens[0].type) && "tokens" in l.tokens[0] && l.tokens[0].tokens
                      ? ((l.tokens[0].raw = c.raw + l.tokens[0].raw), (l.tokens[0].text = c.raw + l.tokens[0].text), l.tokens[0].tokens.unshift(c))
            ...
            if (!e.loose) {
              let u = l.tokens.filter((h) => h.type === "space"),
                c = u.length > 0 && u.some((h) => this.rules.other.anyLine.test(h.raw));
              e.loose = c;
            }
          }
          if (e.loose)
      ...
      def(r) {
        ...
        if (t) {
          let n = t[1].toLowerCase().replace(this.rules.other.multipleSpaceGlobal, " "),
            ...
            e = t[3] ? t[3].substring(1, t[3].length - 1).replace(this.rules.inline.anyPunctuation, "$1") : t[3];
...
`)
        ...
        if (n.length === s.length) {
          ...
          for (let i of e)
            a.rows.push(dt(i, a.header.length).map((o, l) => ({ text: o, tokens: this.lexer.inline(o), header: !1, align: a.align[l] })));
          return a;
        }
      }
      lheading(r) {
...
`
      ...
      link(r) {
        ...
        if (t) {
          ...
          return (
            ...
            gt(
              t,
              { href: s && s.replace(this.rules.inline.anyPunctuation, "$1"), title: e && e.replace(this.rules.inline.anyPunctuation, "$1") },
              t[0],
              this.lexer,
              this.rules
            )
      ...
      reflink(r, t) {
        ...
        if ((n = this.rules.inline.reflink.exec(r)) || (n = this.rules.inline.nolink.exec(r))) {
          ...
          return gt(n, e, n[0], this.lexer, this.rules);
        }
      }
      emStrong(r, t, n = "") {
      ...
      codespan(r) {
        ...
        if (t) {
          let n = t[2].replace(this.rules.other.newLineCharGlobal, " "),
            ...
            e = this.rules.other.startingSpaceChar.test(n) && this.rules.other.endingSpaceChar.test(n);
      ...
      url(r) {
        ...
        if ((t = this.rules.inline.url.exec(r))) {
          ...
          if (t[2] === "@") ((n = t[0]), (s = "mailto:" + n));
            ...
            let e;
            do ((e = t[0]), (t[0] = this.rules.inline._backpedal.exec(t[0])?.[0] ?? ""));
            while (e !== t[0]);
    ...
    w = class G {
      ...
      constructor(t) {
        ...
        let n = { other: b, block: q.normal, inline: z.normal };
        (this.options.pedantic
          ? ((n.block = q.pedantic), (n.inline = z.pedantic))
          : this.options.gfm && ((n.block = q.gfm), this.options.breaks ? (n.inline = z.breaks) : (n.inline = z.gfm)),
      ...
      static lex(t, n) {
        return new G(n).lex(t);
      }
      static lexInline(t, n) {
        return new G(n).inlineTokens(t);
      }
      lex(t) {
        ((t = t.replace(
          b.carriageReturn,
...
`
      ...
      blockTokens(t, n = [], s = !1) {
        for (this.options.pedantic && (t = t.replace(b.tabCharGlobal, "    ").replace(b.spaceLine, "")); t; ) {
          let e;
          if (
            this.options.extensions?.block?.some((i) => ((e = i.call({ lexer: this }, t, n)) ? ((t = t.substring(e.raw.length)), n.push(e), !0) : !1))
          )
            continue;
          if ((e = this.tokenizer.space(t))) {
            t = t.substring(e.raw.length);
            let i = n.at(-1);
            e.raw.length === 1 && i !== void 0
              ? (i.raw += `
`)
              : n.push(e);
            continue;
...
` + e.raw),
                (this.inlineQueue.at(-1).src = i.text))
              : this.tokens.links[e.tag] || ((this.tokens.links[e.tag] = { href: e.href, title: e.title }), n.push(e));
            continue;
          }
...
` + e.text),
      ...
      inlineTokens(t, n = []) {
        ...
        if (this.tokens.links) {
          ...
          if (l.length > 0)
            for (; (e = this.tokenizer.rules.inline.reflinkSearch.exec(s)) != null; )
              l.includes(e[0].slice(e[0].lastIndexOf("[") + 1, -1)) &&
                (s = s.slice(0, e.index) + "[" + "a".repeat(e[0].length - 2) + "]" + s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex));
        }
        for (; (e = this.tokenizer.rules.inline.anyPunctuation.exec(s)) != null; )
          s = s.slice(0, e.index) + "++" + s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex);
        let a;
        for (; (e = this.tokenizer.rules.inline.blockSkip.exec(s)) != null; )
          ((a = e[2] ? e[2].length : 0),
            (s = s.slice(0, e.index + a) + "[" + "a".repeat(e[0].length - a - 2) + "]" + s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex)));
        ...
        for (; t; ) {
          ...
          if (
            this.options.extensions?.inline?.some((c) =>
              (l = c.call({ lexer: this }, t, n)) ? ((t = t.substring(l.raw.length)), n.push(l), !0) : !1
            )
          )
            continue;
    ...
    D = class {
      ...
      code({ text: r, lang: t, escaped: n }) {
        let s = (t || "").match(b.notSpaceStart)?.[0],
          e =
...
`;
      ...
      tablecell(r) {
        let t = this.parser.parseInline(r.tokens),
          n = r.header ? "th" : "td";
        return (
...
`
      ...
      link({ href: r, title: t, tokens: n }) {
        ...
        r = e;
        let a = '<a href="' + r + '"';
        return (t && (a += ' title="' + y(t) + '"'), (a += ">" + s + "</a>"), a);
      }
      image({ href: r, title: t, text: n, tokens: s }) {
        s && (n = this.parser.parseInline(s, this.parser.textRenderer));
        let e = ht(r);
        if (e === null) return y(n);
        r = e;
        let a = `<img src="${r}" alt="${y(n)}"`;
        return (t && (a += ` title="${y(t)}"`), (a += ">"), a);
      }
      text(r) {
    ...
    x = class V {
      ...
      static parse(t, n) {
        return new V(n).parse(t);
      }
      static parseInline(t, n) {
        return new V(n).parseInline(t);
      }
      parse(t) {
        let n = "";
    ...
    ie = class {
        ...
        return (
          r.forEach((n) => {
            ...
            if (
                    ...
                    (a ? a.unshift(e.tokenizer) : (t[e.level] = [e.tokenizer]),
                      e.start &&
                        (e.level === "block"
                          ...
                          : e.level === "inline" && (t.startInline ? t.startInline.push(e.start) : (t.startInline = [e.start]))));
                  }
              ...
              let e = this.defaults.renderer || new D(this.defaults);
            ...
            if (n.tokenizer) {
              let e = this.defaults.tokenizer || new N(this.defaults);
            ...
            if (n.hooks) {
              let e = this.defaults.hooks || new P();
              for (let a in n.hooks) {
                ...
                let i = a,
                  o = n.hooks[i],
                  l = e[i];
                P.passThroughHooks.has(a)
                  ? (e[i] = (u) => {
                      if (this.defaults.async && P.passThroughHooksRespectAsync.has(a))
                        return (async () => {
      ...
      parseMarkdown(r) {
        return (t, n) => {
          let s = { ...n },
            e = { ...this.defaults, ...s },
            a = this.onError(!!e.silent, !!e.async);
          ...
          if ((e.hooks && ((e.hooks.options = e), (e.hooks.block = r)), e.async))
            return (async () => {
              let i = e.hooks ? await e.hooks.preprocess(t) : t,
                o = await (e.hooks ? await e.hooks.provideLexer() : r ? w.lex : w.lexInline)(i, e),
                l = e.hooks ? await e.hooks.processAllTokens(o) : o;
...
Please report this to https://github.com/markedjs/marked.`),
  ...
  return (
    (m.options = m.setOptions =
      function (r) {
        return (A.setOptions(r), (m.defaults = A.defaults), X(m.defaults), m);
      }),
    (m.getDefaults = v),
    (m.defaults = T),
    (m.use = function (...r) {
      return (A.use(...r), (m.defaults = A.defaults), X(m.defaults), m);
    }),
    (m.walkTokens = function (r, t) {
      return A.walkTokens(r, t);
    }),
    ...
    () => {
      ...
      function s() {
        if (t && !t.closed) t.focus();
          ...
          if (((t = window.open("about:blank", "reveal.js - Notes", "width=1100,height=700")), (t.marked = m), t.document.write($), !t)) {
      ...
      function a() {
        const h = n.getConfig().url,
          p = typeof h == "string" ? h : window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search;
        ((r = setInterval(function () {
          t.postMessage(JSON.stringify({ namespace: "reveal-notes", type: "connect", state: n.getState(), url: p }), "*");
        }, 500)),
          window.addEventListener("message", u));
      }
      function i(h, p, g) {
        let f = n[h].apply(n, p);
        t.postMessage(JSON.stringify({ namespace: "reveal-notes", type: "return", result: f, callId: g }), "*");
      }
      function o(h) {
        let p = n.getCurrentSlide(),
          g = p.querySelectorAll("aside.notes"),
          f = p.querySelector(".current-fragment"),
          k = { namespace: "reveal-notes", type: "state", notes: "", markdown: !1, whitespace: "normal", state: n.getState() };
        if ((p.hasAttribute("data-notes") && ((k.notes = p.getAttribute("data-notes")), (k.whitespace = "pre-wrap")), f)) {
          let S = f.querySelector("aside.notes");
          S
            ? ((k.notes = S.innerHTML), (k.markdown = typeof S.getAttribute("data-markdown") == "string"), (g = null))
            : f.hasAttribute("data-notes") && ((k.notes = f.getAttribute("data-notes")), (k.whitespace = "pre-wrap"), (g = null));
        }
        (g &&
          g.length &&
          ((g = Array.from(g).filter((S) => S.closest(".fragment") === null)),
          (k.notes = g.map((S) => S.innerHTML).join(`
`)),
          (k.markdown = g[0] && typeof g[0].getAttribute("data-markdown") == "string")),
          t.postMessage(JSON.stringify(k), "*"));
      }
      function l(h) {
        try {
      ...
      function u(h) {
        if (l(h))
          try {
            ...
            p && p.namespace === "reveal-notes" && p.type === "connected"
              ? (clearInterval(r), c())
              : p && p.namespace === "reveal-notes" && p.type === "call" && i(p.methodName, p.arguments, p.callId);
          } catch {}
      }
      function c() {
        (n.on("slidechanged", o),
          n.on("fragmentshown", o),
          n.on("fragmenthidden", o),
          n.on("overviewhidden", o),
          n.on("overviewshown", o),
          n.on("paused", o),
          n.on("resumed", o),
          n.on("previewiframe", o),
          n.on("previewimage", o),
          n.on("previewvideo", o),
          n.on("closeoverlay", o),
          o());
