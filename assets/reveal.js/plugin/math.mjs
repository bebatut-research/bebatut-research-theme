const M = () => {
    ...
    async function e(t) {
      for (const n of t) await o(n);
    }
    return {
      id: "katex",
      init: function (t) {
        a = t;
        let n = a.getConfig().katex || {},
          i = { ...s, ...n };
        const { local: l, version: u, extensions: $, ...m } = i;
        let p = i.local || "https://cdn.jsdelivr.net/npm/katex",
          c = i.local ? "" : "@" + i.version,
          f = p + c + "/dist/katex.min.css",
          y = p + c + "/dist/katex.min.js",
          j = p + c + "/dist/contrib/mhchem.min.js",
          g = p + c + "/dist/contrib/auto-render.min.js",
          d = [y];
  ...
  x = () => {
    ...
    return {
      ...
      init: function (o) {
        a = o;
        let e = a.getConfig().mathjax2 || a.getConfig().math || {},
          t = { ...s, ...e },
          n = t.mathjax || "https://cdn.jsdelivr.net/npm/mathjax@2/MathJax.js",
        ...
        ((t.tex2jax = { ...s.tex2jax, ...e.tex2jax }),
          ...
          r(l, function () {
            (MathJax.Hub.Config(t),
              MathJax.Hub.Queue(["Typeset", MathJax.Hub, a.getRevealElement()]),
              MathJax.Hub.Queue(a.layout),
              a.on("slidechanged", function (u) {
